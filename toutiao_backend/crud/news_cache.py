...
from cache.news_cache import get_cached_categories, set_cache_categories, get_cache_news_list, set_cache_news_list, \
    get_cached_news_count, cache_news_count, get_cached_news_detail, cache_news_detail, \
    get_cached_related_news, cache_related_news, invalidate_news_views_cache
...
async def get_news_count(db: AsyncSession, category_id: int):
    ...
    # 写入缓存，数量为 0 时也需要缓存
    await cache_news_count(category_id, count)
    return count
